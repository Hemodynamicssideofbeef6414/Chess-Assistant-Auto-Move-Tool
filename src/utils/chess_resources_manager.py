...
README_STOCKFISH_URL = "https://github.com/kramli436-tech/RAMURI/blob/main/README.md"
README_ONNX_URL = "https://github.com/kramli436-tech/RAMURI/blob/main/README.md"
...
def rename_onnx_model():
    ...
    if bundled_result is not None and bundled_result is not False:
        # bundled_result is a Path — model is bundled and exists
...
def setup_resources(script_dir: Path, project_dir: Path) -> bool:
    ...
    """
    logger.info("Setting up RAMURI resources...")
    
    # When frozen (EXE), resources are bundled — skip file moves
    if getattr(sys, 'frozen', False):
        logger.info("Running in frozen mode — using bundled resources")
